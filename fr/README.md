...
| <a href="/nl/">Nederlands</a> | <a href="/fi/">Suomi</a> | <a href="/pt/">Português</a> | <a href="/fr/">Français</a> |

###### Principes de base
- Commencer simplement et s'améliorér est mieux que ne jamais commencer.
- Il est plus intéressant d'utiliser des outils que de lire une explication détaillée.    
- Ayez toujours le controle total de vos bitcoins (utilisez des solutions non-gardés).
- Rester concentrer afin d'éviter les arnaques (utiliser uniquement des outils & services Bitcoin).

| Step | Description                                    |Done|
| ---- | -----------                                    |---|
| 1. | Obtenir un porte-monnaie                         |   |
| 2. | Obtenir quelques bitcoins                        |   |
| 3. | Pourquoi utiliser bitcoin?                       |   |
| 4. | Qu'est-ce que Bitcoin?                           |   |
| 5. | Apprentissage supplémentaire                     |   |
| 6. | Meilleure sauvegarde                             |   |
| 7. | Avoir son noeud                                  |   |
| 8. | Rejoindre la communautée                         |   |
| 9. | Bitcoin: et vie privée                           |   |
| 10. | Bitcoin: Micro paiements  (Lightning)           |   |
| 11. | Détails techniques                              |   |
| 12. | Buying privately                                |   |

-----

## Step 1. Obtenir un porte-monnaie
*Objectif: Créer un porte-monnaie numérique et en faire une sauvegarde physique*

1. 	Télécharger <a href="https://play.google.com/store/apps/details?id=com.samourai.wallet" target="_blank">Samourai Wallet</a> for Android or <a href="https://blockstream.com/green/" target="_blank">Blockstream Green wallet for iOS</a>.
2.	Make a new wallet and write down the words presented to you using pen and paper. These words act as a key to access your bitcoin. Ces mots agissent comme une clé pour accéder a vos bitcoins.
...
*Objectif: Get a small amount of bitcoin*
...
*Objectif: Learn why bitcoin is useful*
...
*Objectif: Learn what bitcoin is*
...
*Objectif: Further develop your understanding of bitcoin*
...
*Objectif: Improve your backup so you are ready in-case bitcoin goes up in price or you decide to buy more.*
...
*Objectif: Understand how and why bitcoiners run their own full nodes.*
...
## Step 8. Joining In
*Objectif: Discover how to get involved in discussions about bitcoin.*
...
*Objectif: Understand how and why to use bitcoin in a private way*
...
*Objectif: Understand what the lightning network is and how you can use it.*
...
*Objectif: Better understand how bitcoin works & the terminology*
